...
import {
  IConsoleRenderer,
  Console,
  URL_PARAM_RENDERER_PIXI_WEBGL,
  URL_PARAM_RENDERER_PIXI_CANVAS,
} from "./console";
/**
 * Class: PixiConsole
...
export class PixiConsoleRenderer implements IConsoleRenderer {
  ...
  private loadFont(
    ...
    this.font = new PIXI.BaseTexture(fontUrl, {
  ...
  private initCanvas(rendererName: string | undefined, con: Console) {
    ...
    this.topLeftPos = new Core.Position(
      $(PixiConsoleRenderer.CANVAS_SELECTOR).offset().left,
    ...
    this.renderer = PIXI.autoDetectRenderer(pixiOptions);
